 ...
 */
class SPUtil private constructor(context: Context, spName: String) {
    ...
    companion object {
        ...
        private val sSPMap = HashMap<String, SPUtil>()
         ...
         * @return [SPUtil]
         */
        fun getInstance(context: Context, spName: String): SPUtil {
            var spName = spName
            if (isSpace(spName)) spName = "spUtils"
            var sp: SPUtil? = sSPMap[spName]
            if (sp == null) {
                sp = SPUtil(context, spName)
